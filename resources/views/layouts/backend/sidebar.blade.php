...
<div id="sidebar"><a href="{{ url('admin/dashboard')}}" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="<?php if($page=='menu'){echo 'active';} ?>"> <a href="{{ url('admin/view')}}"><i class="fas fa-th-large nav-icon"></i> <span>Manage Menu</span></a> </li>
    <li> <a href="widgets.html"><i class="fas fa-th-list nav-icon"></i> <span>Manage Menu Item</span></a> </li>
